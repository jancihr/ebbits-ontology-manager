...
public class Namespace {
	...
	public final static String ontologyURI = "http://ebbits.eu/demo36-core#";
	...
	public final static String inertia = "http://inertia.eu/inertia#";
	public final static String demo_i0 = "http://inertia.eu/demo-bilbao-2013#";
	public final static String demo_i1 = "http://inertia.eu/demo-brussels-2013#";

	public final static String demo_e1 = "http://ebbits.eu/demo-kosice-2014#";
	...
	static {
		...
		prefixes.put("demo-i0", demo_i0);
		prefixes.put("inertia", inertia);
		prefixes.put("demo-i1", demo_i1);
		
		prefixes.put("demo-e1", demo_e1);
	}
	static {
		staticType.add(rdf);
		staticType.add(rdfs);
